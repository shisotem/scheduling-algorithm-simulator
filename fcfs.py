"""
Description: This program simulates the First Come First Service scheduling algorithm.
...
def run_first_come_first_service(task_list: List[Task]) -> None:
    queue: List[Task] = []
    current_time = 0
...
def main() -> None:
    ...
    run_first_come_first_service(task_list)
